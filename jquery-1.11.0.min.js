...
jQuery.fn.highlight=function(a,b){function f(g,l,t){var c=0;if(g.nodeType==3){var s=g.data.toUpperCase().indexOf(l);if(s>=0){var k=document.createElement("span");k.className="highlight";k.style.color=t;if(t){k.style.background="none"}var h=g.splitText(s);var d=h.splitText(l.length);var e=h.cloneNode(true);k.appendChild(e);h.parentNode.replaceChild(k,h);c=1}}else{if(g.nodeType==1&&g.childNodes&&!/(script|style)/i.test(g.tagName)){for(var j=0;j<g.childNodes.length;++j){j+=f(g.childNodes[j],l,t)}}}return c}return this.each(function(){f(this,a.toUpperCase(),b)})};jQuery.fn.removeHighlight=function(){return this.find("span.highlight").each(function(){this.parentNode.firstChild.nodeName;with(this.parentNode){replaceChild(this.firstChild,this);normalize()}}).end()};
